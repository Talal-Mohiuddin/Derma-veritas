        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto mb-8">
              Every skin is unique, and so are your goals. Let us create a personalized treatment package 
              tailored specifically to your needs, concerns, and lifestyle.
            </p>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-base leading-relaxed">
                Tell us about your skin concerns, aesthetic goals, and preferences. 
                Our experts will design a bespoke treatment plan combining the best of our services.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center p-4">
                ...
                <p className="text-sm text-gray-600">Share your specific skin concerns and desired outcomes</p>
              </div>
              <div className="text-center p-4">
                <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="font-medium text-gray-800 mb-2">Your Schedule</h4>
                <p className="text-sm text-gray-600">Tell us about your availability and preferred timeline</p>
              </div>
              <div className="text-center p-4">
                <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-sm text-gray-600">We'll work within your investment range to maximize results</p>
              </div>
            </div>
