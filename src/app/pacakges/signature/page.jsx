...
export default function MembershipProgramPage() {
  ...
  const membershipTiers = [
    ...
    },
    {
      ...
      benefits: [
        ...
        "24/7 priority booking line",
        "Monthly skincare consultations",
        "2x complimentary advanced facial treatments annually",
  ...
  return (
    <>
      ...
      {/* Membership Tiers */}
      <section ref={pricingSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Membership Tiers
