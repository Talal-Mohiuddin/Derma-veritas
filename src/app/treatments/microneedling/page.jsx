  ...
  const cardData = [
    {
      ...
      value: "2-6 Weeks",
      description: "Continued collagen remodeling",
    },
    {
    ...
    },
    {
      heading: "Pain",
      value: "Mild",
      description: "Topical anesthesia applied",
    },
    {
      heading: "Downtime",
      value: "1-2 Days",
  ...
  const faqs = [
    {
      ...
      answer:
        "RF Microneedling is an advanced procedure that uses tiny needles to create controlled micro-injuries in the skin, combined with radiofrequency energy to deliver heat into deeper skin layers. This stimulates collagen and elastin production for smoother, firmer, and rejuvenated skin.",
    },
    {
      question: "When can I see the results?",
      answer:
        "You'll notice improvement in skin texture and firmness within 2-6 weeks, with continued collagen remodeling over time.",
    },
    {
      question: "How long do the results last?",
      answer:
        "Results are long-lasting with progressive improvement as collagen continues to remodel in your skin.",
    },
    {
      question: "Is the procedure painful?",
      answer:
        "Most patients experience only mild discomfort. We apply topical anesthesia as needed to ensure your comfort.",
    },
    {
      question: "What is the downtime?",
      answer:
        "There is minimal downtime of 1-2 days with mild redness and swelling that subsides quickly.",
    },
    {
      question: "Who performs the treatment?",
      answer:
        "All RF Microneedling treatments are performed exclusively by our expert physicians for your safety and optimal results.",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Advanced procedure combining microneedling with radiofrequency energy to stimulate collagen production for skin tightening, scar reduction, and stretch mark improvement.
              </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              RF Microneedling is an advanced procedure that uses tiny needles to create controlled micro-injuries in the skin, stimulating collagen and elastin production for smoother, firmer, and rejuvenated skin. By combining microneedling with radiofrequency (RF) energy, we deliver heat into deeper skin layers, enhancing skin tightening, scar reduction, and stretch mark improvement.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  Deeper collagen stimulation for firmer, more youthful skin
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  Improves skin texture, elasticity, and appearance of fine lines
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  Reduces appearance of wrinkles, acne scars, and stretch marks
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  Targets full face or specific areas with minimal downtime
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  Uses customized solutions and serums to enhance healing
                </li>
              </ul>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="text-gray-600 leading-relaxed space-y-4">
                <p>
                  All RF Microneedling treatments are performed exclusively by our expert
                  physicians who combine microneedling with RF energy for enhanced skin tightening and rejuvenation.
                </p>
                <p>
                  If you would like to discuss RF Microneedling or any of our other treatments, please
                  feel free to{" "}
                ...
                <div className="divide-y divide-gray-200">
                  <div className="py-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Optimal package for best results with progressive improvement
                    </p>
                  </div>
                  <div className="py-3">
                    <div className="flex justify-between items-center mb-2">
