      ...
      <section ref={beforeAfterSectionRef} className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          <div className="rounded-2xl overflow-hidden bg-gray-100">
            <img
              src="/skin_care/RF Microneeling Horizental.jpg"
              alt="RF Microneedling results"
              className="w-full h-full object-cover"
            />
          </div>
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Combines microneedling and RF energy for collagen stimulation,
              tightening, and scar reduction.
            </p>
            <ul className="text-gray-600 space-y-2">
              <li>• Results in 2–6 weeks; continued improvement</li>
              <li>• Long-lasting collagen remodeling</li>
              <li>• 30–60 minutes; 1–2 days downtime</li>
            </ul>
          </div>
        </div>
      </section>
