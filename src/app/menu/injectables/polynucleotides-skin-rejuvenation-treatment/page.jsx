...
import { Eye, CheckCircle, RotateCcw, Clock, Frown, TrendingDown, AlertTriangle, KeyRound as Pound, Droplets, Heart, Sparkles } from "lucide-react";
...
export default function PolynucleotidesSection() {
  ...
  const faqs = [
    {
      ...
      answer: "Polynucleotides (PN) are advanced regenerative molecules derived from natural sources that work at a cellular level to repair, hydrate, and restore the skin. This treatment stimulates collagen and elastin production without adding volume like traditional fillers."
    },
    {
      question: "When can I see the results?",
      answer: "Initial results are visible within 2-4 weeks, with optimal results appearing after completing the recommended treatment sessions."
    },
    {
      question: "How long do the results last?",
      answer: "Results typically last 3-6 months, depending on individual factors and skin condition. Maintenance treatments are recommended for sustained benefits."
    },
    {
  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Polynucleotides<br />Skin Rejuvenation<br />Treatment
              </h2>

              {/* Description */}
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Advanced cellular-level repair and hydration for naturally radiant, youthful-looking skin at Derma Veritas.
              </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Polynucleotides (PN) are advanced regenerative molecules derived from natural sources that work at a cellular level to repair, hydrate, and restore the skin. This treatment stimulates collagen and elastin production, improves skin elasticity, and enhances overall radiance without adding volume like traditional fillers.
            </p>
          </div>
      ...
      {/* BeforeAfterSection would go here */}
      <BeforeAfterSection />
      <ReviewsSection />
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-sm text-gray-600 font-medium">Polynucleotides Cost</span>
              ...
              <div className="border border-gray-200 p-6 bg-white shadow-[3px_3px_6px_rgba(0,0,0,0.15)]">
                ...
                <div className="divide-y divide-gray-200">
                  <div className="flex justify-between items-center py-3">
                    ...
                    <span className="text-lg font-bold text-gray-900">£190</span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                ...
                <div className="divide-y divide-gray-200">
                  <div className="py-3">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-gray-900 font-medium">Annual Maintenance (4 sessions):</span>
