  ...
  export default function EightPointFaceliftSection() {
    ...
    const faqs = [
      {
        question: "What is an 8-point facelift?",
        answer: "The 8-point facelift is a non-surgical treatment using dermal fillers to lift and contour key facial areas, restoring youthful volume and definition without surgery."
      },
      {
        question: "When can I see the results?",
        answer: "Results are visible immediately with optimal results appearing after 2-3 weeks as any swelling subsides."
      },
      {
        question: "How long do the results last?",
        answer: "Results typically last 6-12 months, depending on individual factors and the areas treated."
      },
      {
        question: "Is the procedure painful?",
        answer: "Most patients experience mild discomfort. Local anesthetic can be applied to minimize any pain during treatment."
      },
      {
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
              ...
              <div className="text-center md:text-left flex flex-col justify-center">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  8-Point Facelift for<br />natural facial<br />contouring
                </h2>

                {/* Description */}
                <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                  Achieve a natural, non-surgical facelift using advanced dermal filler techniques at Derma Veritas.
                </p>
              ...
              <div className="relative flex items-center justify-center">
                <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                  <img
                    ...
                    alt="Professional 8-point facelift treatment being administered to a woman"
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                The 8-Point Facelift is a revolutionary non-surgical treatment that uses advanced dermal filler techniques 
                to restore volume, enhance natural contours, and create a lifting effect. This comprehensive approach 
                targets key facial areas to achieve harmonious, natural-looking results.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-gray-600">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    Restored volume and youthful appearance
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    Natural-looking lifting effect
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-gray-600">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                    Jawline definition and sculpting
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
              ...
              <div className="space-y-6">
                <div>
                  <span className="text-sm text-gray-600 font-medium">8-Point Facelift Cost</span>
