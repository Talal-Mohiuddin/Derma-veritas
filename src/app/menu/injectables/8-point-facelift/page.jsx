  ...
  const faqs = [
    {
      ...
      answer:
        "The 8-point facelift is a non-surgical treatment using dermal fillers to lift and contour key facial areas, restoring youthful volume and definition without surgery.",
    },
    {
      question: "When can I see the results?",
      answer:
        "Results are visible immediately with optimal results appearing after 2-3 weeks as any swelling subsides.",
    },
    {
      question: "How long do the results last?",
      answer:
        "Results typically last 6-12 months, depending on individual factors and the areas treated.",
    },
    {
      question: "Is the procedure painful?",
      answer:
        "Most patients experience mild discomfort. Local anesthetic can be applied to minimize any pain during treatment.",
    },
    {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Achieve a natural, non-surgical facelift using advanced dermal
                filler techniques at Derma Veritas.
              </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              The 8-Point Facelift is a revolutionary non-surgical treatment
              that uses advanced dermal filler techniques to restore volume,
              enhance natural contours, and create a lifting effect. This
              comprehensive approach targets key facial areas to achieve
