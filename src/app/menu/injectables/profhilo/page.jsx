...
import { Eye, CheckCircle, RotateCcw, Clock, Frown, TrendingDown, AlertTriangle, KeyRound as Pound, Droplets, Heart, Sparkles, Shield } from "lucide-react";
  ...
  const faqs = [
    {
      ...
      answer: "Profhilo® is an innovative injectable treatment made of ultra-pure hyaluronic acid, designed to deeply hydrate and remodel the skin. Unlike traditional fillers, Profhilo® spreads evenly across the skin to boost elasticity, firmness, and glow."
    },
    {
      question: "Which areas can be treated with Profhilo®?",
      answer: "Profhilo® is ideal for improving skin quality of the face, neck, décolletage, and hands."
    },
    {
      question: "When can I see the results?",
      answer: "You'll notice improved hydration and glow after 2–4 weeks, with best results appearing after the full course of treatments."
    },
    {
      question: "How long do the results last?",
      answer: "Results typically last 6–8 months, depending on your lifestyle and skin condition."
    },
    {
    ...
    },
    {
      ...
      answer: "There is minimal downtime. Some patients may experience temporary redness or swelling for up to 24 hours."
    },
    {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Profhilo® Skin Booster<br />for deep hydration<br />& radiance
              </h2>

              {/* Description */}
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Achieve deeply hydrated, glowing skin with Profhilo® - the innovative injectable treatment that boosts skin quality from within.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-8">
              ...
              <div className="text-center md:text-left">
                ...
                {cardData[2].description && (
                  <p className="text-gray-500 text-sm font-light mt-1">{cardData[2].description}</p>
                )}
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Profhilo® is an innovative injectable treatment made of ultra-pure hyaluronic acid, 
              designed to deeply hydrate and remodel the skin. Unlike traditional fillers, Profhilo® 
              spreads evenly across the skin to boost elasticity, firmness, and glow. It is ideal for 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-900">Treatment Areas:</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-sm text-gray-600 font-medium">Profhilo® Treatment Cost</span>
              ...
              <div className="text-gray-600 leading-relaxed space-y-4">
                ...
                <p>
                  We use the BAP injection technique for maximum lifting & hydration, ensuring clinically proven 
                  treatment with global recognition.
                </p>
                <p>
            ...
            <div className="space-y-6">
              ...
              <div className="border border-gray-200 p-6 bg-white shadow-[3px_3px_6px_rgba(0,0,0,0.15)]">
                ...
                <div className="divide-y divide-gray-200">
                  ...
                  <div className="flex justify-between items-center py-3">
                    <span className="text-gray-700">2 Sessions (recommended):</span>
                    <span className="text-lg font-bold text-gray-900">£550</span>
                  </div>
                  <div className="flex justify-between items-center py-3">
                ...
                <div className="divide-y divide-gray-200">
                  <div className="py-3">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-lg font-bold text-gray-900">From £300</span>
                    </div>
                  ...
                  <div className="py-3">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-gray-900 font-medium">Décolletage:</span>
                      <span className="text-lg font-bold text-gray-900">From £300</span>
                    </div>
                    <p className="text-sm text-gray-600">
