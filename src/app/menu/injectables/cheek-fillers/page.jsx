...
export default function CheekFillersSection() {
  ...
  const faqs = [
    {
      question: "What are cheek fillers?",
      answer: "Cheek fillers are dermal fillers specifically designed to add volume, enhance natural contours, and restore youthful fullness to the cheek area."
    },
    {
      question: "When can I see the results?",
      answer: "Results are visible immediately with optimal results appearing after 2-3 weeks as any swelling subsides and the filler settles naturally."
    },
    {
      question: "How long do the results last?",
      answer: "Cheek filler results typically last 6-12 months, depending on individual factors such as metabolism and the type of filler used."
    },
    {
      question: "Is the procedure painful?",
      answer: "Most patients experience mild discomfort. We use fine needles and can apply local anesthetic to minimize any pain during treatment."
    },
    {
      question: "What is the recovery like?",
      answer: "There is minimal downtime. Some patients may experience temporary swelling, redness, or mild bruising for a few days."
    },
    {
      question: "Who performs the treatment?",
      answer: "All treatments are performed exclusively by our expert physicians and clinical pharmacy leads who are industry-leading trainers with extensive experience."
    }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Enhance your cheeks<br />for a youthful<br />contoured look
              </h2>

              {/* Description */}
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Restore volume and create beautiful definition with expert cheek filler treatments at Derma Veritas.
              </p>
            ...
            <div className="relative flex items-center justify-center">
              <div className="rounded-3xl overflow-hidden bg-gray-200 aspect-[4/5] w-full max-w-lg">
                <img
                  ...
                  alt="Professional cheek filler treatment being administered to a woman"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Cheek fillers are non-surgical, minimally invasive treatments that add volume and enhance the natural 
              contours of your cheeks. Using advanced dermal filler techniques, we restore youthful fullness, 
              create beautiful definition, and achieve a natural, harmonious appearance that complements your 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  Natural-looking lift and volume
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-3">
                  ...
                  Detailed consultation and facial assessment
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                ...
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  Precise injection technique using fine needles
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                  Immediate results with continued improvement
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-start">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-sm text-gray-600 font-medium">Cheek Filler Cost</span>
              ...
              <div className="border border-gray-200 p-6 bg-white shadow-[3px_3px_6px_rgba(0,0,0,0.15)]">
                ...
                <div className="divide-y divide-gray-200">
                  <div className="flex justify-between items-center py-3">
                    <span className="text-gray-700">Lip, Cheek, Chin (0.5-1.0ml):</span>
                ...
                <div className="divide-y divide-gray-200">
                  <div className="py-3">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-gray-900 font-medium">Lift & Reshape Package:</span>
                      <span className="text-lg font-bold text-gray-900">£1,950</span>
                    </div>
                  ...
                  <div className="py-3">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-gray-900 font-medium">Custom Treatment Plan:</span>
                      <span className="text-lg font-bold text-gray-900">Consultation</span>
                    </div>
                    <p className="text-sm text-gray-600">
