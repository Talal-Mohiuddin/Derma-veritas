  ...
  const faqs = [
    {
      ...
      answer:
        "Cheek fillers are dermal fillers specifically designed to add volume, enhance natural contours, and restore youthful fullness to the cheek area.",
    },
    {
      question: "When can I see the results?",
      answer:
        "Results are visible immediately with optimal results appearing after 2-3 weeks as any swelling subsides and the filler settles naturally.",
    },
    {
      question: "How long do the results last?",
      answer:
        "Cheek filler results typically last 6-12 months, depending on individual factors such as metabolism and the type of filler used.",
    },
    {
      question: "Is the procedure painful?",
      answer:
        "Most patients experience mild discomfort. We use fine needles and can apply local anesthetic to minimize any pain during treatment.",
    },
    {
      question: "What is the recovery like?",
      answer:
        "There is minimal downtime. Some patients may experience temporary swelling, redness, or mild bruising for a few days.",
    },
    {
      question: "Who performs the treatment?",
      answer:
        "All treatments are performed exclusively by our expert physicians and clinical pharmacy leads who are industry-leading trainers with extensive experience.",
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Restore volume and create beautiful definition with expert cheek
                filler treatments at Derma Veritas.
              </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Cheek fillers are non-surgical, minimally invasive treatments that
              add volume and enhance the natural contours of your cheeks. Using
              advanced dermal filler techniques, we restore youthful fullness,
              create beautiful definition, and achieve a natural, harmonious
              appearance that complements your unique facial structure.
            </p>
          </div>
