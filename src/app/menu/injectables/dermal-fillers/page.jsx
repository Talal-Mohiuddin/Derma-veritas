  ...
  return (
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center min-h-[600px]">
            ...
            <div className="text-center md:text-left flex flex-col justify-center">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Restore volume and <br />enhance your natural <br />beauty with precision
              </h2>

              {/* Description */}
              <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-xl mx-auto md:mx-0 mt-6">
                Discover the art of facial rejuvenation and contouring with expert dermal filler treatments at AL Aesthetics.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div>
                <span className="text-sm text-gray-600 font-medium">Expert Facial Rejuvenation</span>
              ...
              <div className="text-gray-600 leading-relaxed space-y-4">
                <p>
                  Dermal fillers are non-surgical, minimally invasive treatments that add volume, 
                  smooth lines, and rejuvenate your appearance. They can enhance lips, cheeks, 
                  chin, jawline, and under-eye areas with immediate, safe, and natural-looking results.
                </p>
                <p>
                  Our expert physicians and clinical pharmacy lead specialists use advanced techniques 
                  to restore volume, enhance natural contours, and create harmonious facial balance. 
                  Every treatment is tailored to your individual facial structure and aesthetic goals.
                </p>
              </div>

              {/* Why Choose Our Clinic */}
              <div className="space-y-3">
                <h3 className="text-lg font-semibold text-gray-900">Why Choose Our Clinic:</h3>
            ...
            <div className="bg-white border border-gray-200 p-8 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Treatment Benefits</h3>
              
              <div className="space-y-4">
                <div className="flex items-start gap-3 py-2">
                  <div className="w-2 h-2 bg-[#272728] rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-medium text-gray-900">Immediate Results</h4>
                    <p className="text-sm text-gray-600">Visible improvement right after treatment</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 py-2">
                  <div className="w-2 h-2 bg-[#272728] rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-medium text-gray-900">Natural Enhancement</h4>
                    <p className="text-sm text-gray-600">Maintain your unique facial features</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 py-2">
                  <div className="w-2 h-2 bg-[#272728] rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="font-medium text-gray-900">Minimal Downtime</h4>
                ...
                <div className="flex items-start gap-3 py-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Results last 6-12 months</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our expert physicians provide dermal filler treatments for various facial areas, 
              each tailored to enhance your natural beauty and restore youthful vitality.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {treatmentAreas.map((area, index) => (
              <div key={index} className="bg-white border border-gray-200 overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div>
                      <span className="text-2xl font-bold text-gray-900">{area.price}</span>
                      <span className="text-sm text-gray-600 ml-2">({area.volume})</span>
                    </div>
                  </div>
      ...
      <section className="py-12 md:py-20 px-4" style={{ backgroundColor: "#f6f6f6" }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-sm text-gray-600 font-medium">Dermal Filler Costs</span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mt-2 mb-6">
              Our Pricing
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              All of our prices reflect the expertise and experience of our team. 
              Contact us to discuss any treatments or create a personalized treatment plan.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-gray-200 p-6 bg-white shadow-[3px_3px_6px_rgba(0,0,0,0.15)]">
              ...
              <div className="divide-y divide-gray-200">
                <div className="flex justify-between items-center py-4">
                  <div>
                    <span className="text-gray-900 font-medium">Lip, Cheek, Chin</span>
                ...
                <div className="flex justify-between items-center py-4">
                  <div>
                    <span className="text-gray-900 font-medium">Additional 1.0 ml</span>
                    <div className="text-sm text-gray-600">Perfect for refining results</div>
                  </div>
                ...
                <div className="flex justify-between items-center py-4">
                  <div>
                    <span className="text-gray-900 font-medium">Russian Lip Technique</span>
                    <div className="text-sm text-gray-600">Full, lifted, beautifully shaped lips</div>
                  </div>
            ...
            <div className="border border-gray-200 p-6 bg-white shadow-[3px_3px_6px_rgba(0,0,0,0.15)]">
              ...
              <div className="divide-y divide-gray-200">
                <div className="flex justify-between items-center py-4">
                  <div>
                    <span className="text-gray-900 font-medium">Jawline Sculpting</span>
                    <div className="text-sm text-gray-600">(3.0 ml) Sharper facial contour</div>
                  </div>
                ...
                <div className="flex justify-between items-center py-4">
                  <div>
                    <span className="text-gray-900 font-medium">Tear Trough</span>
                    <div className="text-sm text-gray-600">Brightens under-eye area</div>
                  </div>
                  <span className="text-xl font-bold text-gray-900">£450</span>
                </div>
                ...
                <div className="flex justify-between items-center py-4">
                  <div>
                    <span className="text-gray-900 font-medium">Non-Surgical Rhinoplasty</span>
                    <div className="text-sm text-gray-600">Balanced nose contours</div>
                  </div>
                  <span className="text-xl font-bold text-gray-900">£450</span>
                </div>
              </div>
