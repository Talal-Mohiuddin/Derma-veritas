...
export default function ClubMembership() {
  return (
    <section
      className="py-10 px-6 md:px-12 lg:px-20 bg-gray-900"
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center md:justify-between gap-6 md:gap-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-semibold text-white">Club</h2>
              <h3 className="text-xl md:text-2xl font-light text-gray-300">Membership</h3>
            </div>
          </div>
          ...
          <div className="text-center md:flex-1">
            <p className="text-gray-300 text-base md:text-lg">
              ...
              <span className="font-semibold text-white">Prices start from £54 per month*</span>
            </p>
          </div>
