      ...
      <header className="bg-gray-100 px-4 py-2">
        ...
        <nav className="bg-white px-4 py-4 border-b sticky top-0 z-40 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <BookingModal>
              <Button className="relative !px-12 !py-8 text-xs font-bold uppercase text-white bg-[#272728] rounded-none tracking-wide">
            ...
            <button
              ...
              className="flex items-center justify-between px-6 py-4 border border-gray-300 bg-white rounded-none"
            >
              <span className="text-sm font-medium text-gray-800 mr-3">MENU</span>
